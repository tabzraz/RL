...
from Agent.DQN_Model_Agent import DQN_Model_Agent
...
class Trainer:
    ...
    def __init__(self, args, env, eval_env):
        ...
        elif args.bonus_replay:
            self.agent = DQN_Agent_TwoReplay(args, self.exp_model, agent_log_funcs)
        elif args.sarsa:
        ...
        #     self.agent = NEC_Agent(args, self.exp_model, agent_log_funcs)
            ...
            self.agent = DQN_Model_Agent(args, self.exp_model, agent_log_funcs)
        else:
