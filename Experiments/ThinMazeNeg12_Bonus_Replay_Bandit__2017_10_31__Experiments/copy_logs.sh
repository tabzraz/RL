...
ssh -t brown "cp -r /data/brown/tabhid/Server_Logs/ThinMazeNeg12_Bonus_Replay_Bandit__2017_10_31 /data/savitar/tabhid/Runs/Servers/ThinMazeNeg12_Bonus_Replay_Bandit__2017_10_31"

echo "Finished copying brown Logs"

echo "Copying dgx1 Logs"
ssh -t dgx1 "cp -r /data/dgx1/tabhid/Server_Logs/ThinMazeNeg12_Bonus_Replay_Bandit__2017_10_31 /data/savitar/tabhid/Runs/Servers/ThinMazeNeg12_Bonus_Replay_Bandit__2017_10_31"
