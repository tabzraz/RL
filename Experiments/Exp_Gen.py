...
reward_replays = [x * 1000 for x in [5, 10, 20, 50]]
reward_iters = [(r, r) for r in reward_replays]
                                                                    ...
                                                                    for reward_clip in reward_clips:
                                                                        for reward_replay_xp, reward_replay_iters in reward_iters:
                                                                            for seed in seeds:
                                                                                ...
                                                                                #     else:
                                                                                #         name += "_Options"
                                                                                name += "_{}k_Reward_{}k_RIters".format(str(reward_replay_xp)[:-3], str(reward_replay_iters)[:-3])
                                                                                if tabular:
                                                                                    name += "_TABULAR"
                                                                                if count:
