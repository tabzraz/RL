...
prioritizeds = [(True, False, 2, False), (True, False, -2, False), (True, False, 10, False), (True, False, -10, False)]  # [(True, False, True), (True, True, True)]
count_td_scalers = [1]
                                            ...
                                            for beta in betas:
                                                for cts_size in cts_sizes:
                                                    for neg_reward, neg_reward_scaler in negative_rewards:  #[(n, ns) for n in negative_rewards for ns in negative_reward_scaler]:
                                                        for prioritized, is_weight, neg_scaler, sub_pseudo_reward in prioritizeds:
