...
epsilon_steps = [50000]
batch_sizes = [(32, 1)]
xp_replay_sizes = [x * 1000 for x in [100, 500, 1000]]
...
prioritizeds = [(False, False, False, False), (True, False, False, False), (True, True, False, False)]  # [(True, False, True), (True, True, True)]
count_td_scalers = [1]
