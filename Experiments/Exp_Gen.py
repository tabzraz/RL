...
reward_replays = [x * 1000 for x in [10, 50]]
r_iters = [1, 4]
reward_iters = [(r, ri) for r in reward_replays for ri in r_iters]
                                                            ...
                                                            for n_mixing in n_step_mixings:
                                                                for set_replay, set_replay_num in set_replays:
                                                                    for reward_clip in reward_clips:
                                                                        for reward_replay_xp, reward_replay_iters in reward_iters:
                                                                            for seed in seeds:
                                                                                ...
                                                                                #     else:
                                                                                #         name += "_Options"
                                                                                name += "_{}k_Reward_{}_RIters".format(str(reward_replay_xp)[:-3], reward_replay_iters)
                                                                                if tabular:
                                                                                    name += "_TABULAR"
                                                                                if count:
                                                                                ...
                                                                                python_command += " --reward-replay {} --reward-iters {}".format(reward_replay_xp, reward_replay_iters)
                                                                                # if option:
                                                                                #     if random_macros:
