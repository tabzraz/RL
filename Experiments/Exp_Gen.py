                                                    ...
                                                    for cts_size in cts_sizes:
                                                        for neg_reward, neg_reward_scaler in negative_rewards: #[(n, ns) for n in negative_rewards for ns in negative_reward_scaler]:
                                                            for num_state in num_states:
                                                                for lamb in lambdas:
                                                                    for special_t, exp_bonus_save in trajs:
                                                                        for seed in seeds:
                                                                            ...
                                                                            if special_t:
                                                                                name += "_Trajectory_{}_Save".format(exp_bonus_save)
                                                                            # if option:
                                                                            #     if random_macros:
                                                                            ...
                                                                            if special_t:
                                                                                python_command += " --trajectory --exp-bonus-save {}".format(exp_bonus_save)
                                                                            if count:
